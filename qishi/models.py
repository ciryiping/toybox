...
#override topic.objects by a model manager to hide hidden topics
class TopicManager(models.Manager):
    def get_queryset(self):
        return super(TopicManager, self).get_queryset().filter(hidden=False)

#not sure yet may be useful later
LEVEL_CHOICES = (
    (30, _('Default')),
    (60, _('Distillate')),
)
